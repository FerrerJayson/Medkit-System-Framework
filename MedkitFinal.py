...
from tkinter import Canvas, Entry, Image, Label, PhotoImage, StringVar, filedialog, Text,ttk,Frame,OptionMenu,Spinbox
...
class namepage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def select(value):
                if value == "DELETE":
                    usrnentry.delete(len(usrnentry.get())-1)

                elif value == " SPACE ":
                    usrnentry.insert(END, ' ')

                elif value == "ENTER":
                    enter()

                else:
                    usrnentry.insert(END, value)
...
class pinpage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        global dtpanel4
        dtpanel4=Label(self,text="Welcome "+login,fg="black", bg="white",borderwidth=0,font=('Helvetica',40))
        dtpanel4.place(x=460,y=155)
        usrnentry = tk.Entry(self,fg="black", bg="white",textvariable=name_var, width=15,borderwidth=0,font=('Helvetica',40), justify='center')
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        clicked_dose = StringVar()
        clicked_meds = StringVar()
        ...
        whtmeds=Label(self,image=wht,borderwidth=0)
        btn_meds= PhotoImage(file="inmed.png")
        ...
        dose = OptionMenu( self , clicked_dose , *dose_options )
        meds = OptionMenu( self , clicked_meds , *meds_options )
        global dosep
